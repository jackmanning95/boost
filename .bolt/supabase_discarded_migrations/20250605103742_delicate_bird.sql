...
BEGIN
  ...
  DROP POLICY IF EXISTS "Users can view own requests or all requests if admin" ON audience_requests;
  ...
  DROP POLICY IF EXISTS "Users can view own advertiser accounts" ON advertiser_accounts;
