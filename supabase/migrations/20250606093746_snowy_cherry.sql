/*
  ...
  1. New Tables
    - `campaign_comments`
      ...
      - `parent_comment_id` (uuid, optional, references campaign_comments for replies)
  ...
  2. Security
    ...
    - Add policy for users to read comments on campaigns they have access to
    - Add policy for users to delete their own comments (optional)
    - Add policy for admins to read all comments

  3. Indexes
    - Index on campaign_id for performance
