/*
  ...
  1. Schema Updates
    ...
    - Update user roles to support: admin, user, super_admin
    - Update constraints and triggers

  2. Security
    - Enhanced RLS policies for multi-company support
    - Super admin access for @boostdata.io emails
    - Company admin controls within their organization
