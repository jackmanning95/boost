...
BEGIN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'companies' 
    AND policyname = 'Only admins can insert companies'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'companies' 
    AND policyname = 'Only admins can update companies'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'campaign_activity_log' 
    AND policyname = 'Users can read activity for their company campaigns'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Users can read profiles in their company'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Users can read campaigns for their company'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'campaign_comments' 
    AND policyname = 'Users can read comments for their company campaigns'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'campaign_comments' 
    AND policyname = 'Users can create comments on their company campaigns'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'campaign_workflow_history' 
    AND policyname = 'Users can read workflow history for their company campaigns'
  ) THEN
