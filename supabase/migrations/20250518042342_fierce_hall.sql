/*
  # Update audiences table schema and policies

  1. Table Structure
    - Creates audiences table with full-text search capabilities
    - Adds search_vector column for efficient text search
    - Includes indexes for performance optimization

  2. Security
    - Enables RLS
    - Sets up policies for authenticated users and admins
    - Ensures proper access control for CRUD operations

  3. Automation
    - Adds triggers for search vector updates
